...
主要参考了以下几篇教程：
[[https://coldnight.github.io/dump-brain-with-emacs/posts/20220107175445-工欲善其事_必先利其器_emacs_配置篇/][emacs配置]]
[[fn:footprint1][脚注1]]
* 常用功能
...
- 截图、插入图片并显示[fn:pic1][fn:pic2]
  首先在init中配置org-download，就能实现C-M-y快捷键截图插入，同时保存在"~/notes/images"目录下
#+begin_src
;; 图片管理
...
#+end_src
但是还不能实现将剪贴板中已有的图片插入到文本中，之后再研究一下
...
(package-install 'zotxt)
  ...
  #+end_src
  [[zotero://select/items/1_U7ZEA832][Wang, Zihao, Fudong Wang, Haipeng Zhang, Minghui Yang, Shaosheng Cao, Zujie Wen和Zhe Zhang. 《`Could You Describe the Reason for the Transfer?’: A Reinforcement Learning Based Voice-Enabled Bot Protecting Customers from Financial Frauds》, 不详, 10.]]
[[zotero://select/items/1_TS229HQ6][Thoppilan, Romal, Daniel De Freitas, Jamie Hall, Noam Shazeer, Apoorv Kulshreshtha, Heng-Tze Cheng, Alicia Jin, 等. 《LaMDA: Language Models for Dialog Applications》. arXiv, 2022年2月10日. http://arxiv.org/abs/2201.08239.]]
